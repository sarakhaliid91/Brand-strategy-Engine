...
--> seed the single strategist login (change the password after first sign-in)
INSERT INTO "users" ("email", "password_hash")
VALUES ('sarakhaliid91@gmail.com', '$2b$10$fvGTVN3BNMkozUKvVDzXWeKgkUMy52I1UC.VLhJiZyqmTN8QkBf.y')
