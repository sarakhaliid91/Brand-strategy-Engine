        ...
        {def.mode !== "manual" && formBody && (
          <div className="mt-4 flex flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-6">
            <div className="flex items-center justify-between">
              ...
              <form action={generateSectionAction.bind(null, projectId, type)}>
                <button
                  type="submit"
                ...
                >
                  {statement ? "Regenerate" : "Generate"}
                </button>
              </form>
            </div>
            {statement ? (
              <p className="whitespace-pre-wrap text-sm text-zinc-800">{statement}</p>
            ) : (
